...
| ⚠10 — Prazo de requerimento | Adicionado ao blueprint após sessão grill — etapa: Redirecionamento (A+C), Frontstage URA; derivado de v3 §1.3 e §6.4. Alinha com os demais fail points estruturais do Ramo A+C |
| ⚠11 — Confusão de parcelas por nº de solicitação | Adicionado ao blueprint após sessão grill — etapa: Consulta (B), Frontstage URA + Backstage Caixa; derivado de v3 §6.2 e §7 item 15. Complementa ⚠FP14 (v3) sobre confusão entre modalidades |
