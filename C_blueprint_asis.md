...
|---|---|---|---|---|---|---|---|---|
| **EVIDÊNCIAS FÍSICAS** | Locução/menu URA | Tempo de espera em fila | — | Senha Cidadão (6 dígitos DTMF) · Mensagem de bloqueio por tentativas ★ | Status Caixa Tem/Benefícios Sociais Caixa · Status CTPS Digital · Mensagens genéricas de erro · Calendário de pagamento · ~~Aviso de prazo de 67 dias~~ ⚠6 | — | Protocolo de reclamação | — |
| **— LINHA DE INTERAÇÃO —** | | | | | | | | |
